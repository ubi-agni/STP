...
class Stp3 {
public:
	static const string PROFILE_T;  ///< trapezoid shaped profile
	static const string PROFILE_W;  ///< wedge shaped profile
	static const string PROFILE_STOP; ///< fullstop profile
